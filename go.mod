module github.com/chriskolenko/golang-rest

go 1.19

require (
	github.com/contextcloud/eventstore v0.1.26
...
require (
	...
	github.com/WinterYukky/gorm-extra-clause-plugin v0.1.3 // indirect
	...
	github.com/swaggest/usecase v1.2.0 // indirect
